package com.example.wherebnb.global.config;

import com.example.wherebnb.global.jwt.JwtAuthenticationFilter;
import com.example.wherebnb.global.jwt.JwtUtil;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .requestMatchers("/swagger-ui/**","/v3/api-docs/**","/main/**").permitAll()
